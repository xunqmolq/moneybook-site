...
export function IconHomeMoneybookMobile() {
  return (
    <Mobile>
      <div className = {s.Mobile}>
        <IconHomeMobile className={s.Moneybook} />
      </div>
    </Mobile>
  );
}
export function IconHomeMoneybookTablet() {
  return (
    <Tablet> 
      <div className = {s.Tablet}>
        <IconHomeTablet className={s.Moneybook} />
      </div>
    </Tablet>
  );
}
export function IconHomeMoneybookDesktop() {
  return (
    <Desktop> 
      <div className = {s.Desktop}>
        <IconHomeDesktop className={s.Moneybook} />
      </div>
    </Desktop>
  );
}
